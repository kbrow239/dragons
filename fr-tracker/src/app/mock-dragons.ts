...
export const DRAGONS: Dragon[] = [
    {dragonId: 3864048, name: 'Stoli', gender: 'Male', breed: 'Nocturne', primary_color: 'Obsidian', primary_gene: 'Wasp',
    ...
    {dragonId: 29572379, name: 'Etera', gender: 'Female', breed: 'Nocturne', primary_color: 'Obsidian', primary_gene: 'Wasp',
    ...
    {dragonId: 43029482, name: 'Isa', gender: 'Female', breed: 'Wildclaw', primary_color: 'Cerulean', primary_gene: 'Python',
    ...
    {dragonId: 42694825, name: 'Odell', gender: 'Male', breed: 'Wildclaw', primary_color: 'Teal', primary_gene: 'Python',
    ...
    {dragonId: 50462051, name: 'Nyktos', gender: 'Male', breed: 'Nocturne', primary_color: 'Cerulean', primary_gene: 'Starmap',
    ...
    {dragonId: 51186426, name: 'Speirr', gender: 'Male', breed: 'Coatl', primary_color: 'Teal', primary_gene: 'Starmap',
    ...
    {dragonId: 51351517, name: 'Mido', gender: 'Female', breed: 'Wildclaw', primary_color: 'Cerulean', primary_gene: 'Starmap',
